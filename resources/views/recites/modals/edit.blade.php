<div class="modal fade{{--  show --}}" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"{{--  style="display:block;" --}}>
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <button id="product-add-2" class="btn btn-primary" type="button">Agregar Producto</button>
        <hr>
